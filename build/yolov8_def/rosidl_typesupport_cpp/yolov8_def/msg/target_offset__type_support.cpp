...
static const _TargetOffset_type_support_symbol_names_t _TargetOffset_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolov8_def, msg, TargetOffset)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolov8_def, msg, TargetOffset)),
  }
};
...
{
  return &::yolov8_def::msg::rosidl_typesupport_cpp::TargetOffset_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, yolov8_def, msg, TargetOffset)() {
  return get_message_type_support_handle<yolov8_def::msg::TargetOffset>();
}
