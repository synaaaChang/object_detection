...
bool yolov8_def__msg__boundingboxresult__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolov8_def.msg._boundingboxresult.Boundingboxresult", full_classname_dest, 51) == 0);
  }
  yolov8_def__msg__Boundingboxresult * ros_message = _ros_message;
  {  // class_name
...
{
  /* NOTE(esteve): Call constructor of Boundingboxresult */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolov8_def.msg._boundingboxresult");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Boundingboxresult");
